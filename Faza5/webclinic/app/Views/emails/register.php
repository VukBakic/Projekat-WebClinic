        ...
        <tr>
            <td valign="top">
                ...
                <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center" class="container  container--main" width="680">
                    ...
                    <tr>
                        <td>
                            <h1>Uspesno ste se registrovali na portalu Web Clinic!</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <p>Postovani <?= $ime ?> <?= $prezime ?> hvala Vam na registraciji.</p>
                        </td>
                    </tr>
                    ...
                    <!-- Section -->
						 <tr>
                        <td>
                        	<h3>Vasi podaci za pristup web portalu su:</h3>
								 </td>
                    </tr>
						 <tr class="list">
							 <td>
								<p><b>Email address:</b> <?= $email ?> </p>
								<p><b>Password:</b> <?= $sifra ?></p>
