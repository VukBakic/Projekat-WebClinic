 ...
 */
class Sadrzi extends \App\Models\Entities\Sadrzi implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Sadrzi' . "\0" . 'idstavka', '' . "\0" . 'App\\Models\\Entities\\Sadrzi' . "\0" . 'idfajl'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Sadrzi $proxy) {
    ...
    public function setIdfajl($idfajl)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdfajl', [$idfajl]);

        return parent::setIdfajl($idfajl);
    }
