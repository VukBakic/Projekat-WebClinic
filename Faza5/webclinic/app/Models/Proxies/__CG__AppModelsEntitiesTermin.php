 ...
 */
class Termin extends \App\Models\Entities\Termin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Termin' . "\0" . 'datum', '' . "\0" . 'App\\Models\\Entities\\Termin' . "\0" . 'vreme', '' . "\0" . 'App\\Models\\Entities\\Termin' . "\0" . 'idtermin', '' . "\0" . 'App\\Models\\Entities\\Termin' . "\0" . 'idlekar'];
        }
    ...
    public function setVreme($vreme)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVreme', [$vreme]);

        return parent::setVreme($vreme);
    }
    ...
    public function getVreme()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVreme', []);

        return parent::getVreme();
    }
