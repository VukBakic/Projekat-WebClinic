 ...
 */
class Pitanjeklijent extends \App\Models\Entities\Pitanjeklijent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Pitanjeklijent' . "\0" . 'idpitanje', '' . "\0" . 'App\\Models\\Entities\\Pitanjeklijent' . "\0" . 'idklijent'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pitanjeklijent $proxy) {
