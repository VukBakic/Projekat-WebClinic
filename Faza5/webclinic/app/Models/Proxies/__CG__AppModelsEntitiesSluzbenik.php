 ...
 */
class Sluzbenik extends \App\Models\Entities\Sluzbenik implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entities\\Sluzbenik' . "\0" . 'idsluzb'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Sluzbenik $proxy) {
