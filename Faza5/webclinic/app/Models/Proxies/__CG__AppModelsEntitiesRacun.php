 ...
 */
class Racun extends \App\Models\Entities\Racun implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Racun $proxy) {
    ...
    public function setPlaceno($placeno)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPlaceno', [$placeno]);

        return parent::setPlaceno($placeno);
    }
